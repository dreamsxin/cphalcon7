...
namespace Phalcon\Http {
	...
	class Request extends \Phalcon\Di\Injectable implements \Phalcon\Events\EventsAwareInterface, \Phalcon\Di\InjectionAwareInterface, \Phalcon\Http\RequestInterface {
		 ...
		 * @return mixed
		 */
		protected function _get($data, $name, $filters, $defaultValue, $notAllowEmpty, $noRecursive){ }
		 ...
		 * @return string
		 */
		public function getBsonRawBody(){ }
		 ...
		 */
		public function getUploadedFiles($notErrored=null, $index=null){ }
