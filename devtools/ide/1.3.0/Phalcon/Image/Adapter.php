...
namespace Phalcon\Image {
	...
	abstract class Adapter implements \Phalcon\Image\AdapterInterface {
		 ...
		 * @return string
		 */
		public function getColorRBG($color){ }
		...
		abstract protected function _save($file, $opacity=null, $interlacing=null);


		abstract protected function _render($type, $opacity=null, $interlacing=null);
