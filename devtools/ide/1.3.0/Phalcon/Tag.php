...
namespace Phalcon {
	...
	class Tag {
		 ...
		 * @return string
		 */
		public static function imageInput($parameters=null, $local=null){ }
		 ...
		 * @return string
		 */
		public static function stylesheetLink($parameters=null, $local=null, $args=null){ }
		 ...
		 * @return string
		 */
		public static function javascriptInclude($parameters=null, $local=null, $args=null){ }
		...
		public static function choice($expression, $value1, $value2=null){ }


		public static function color($parameters){ }


		public static function text($parameters){ }


		public static function number($parameters){ }


		public static function range($parameters){ }


		public static function email($parameters){ }


		public static function date($parameters){ }


		public static function dateTime($parameters){ }


		public static function dateTimeLocal($parameters){ }


		public static function month($parameters){ }


		public static function time($parameters){ }


		public static function week($parameters){ }


		public static function password($parameters){ }


		public static function hidden($parameters){ }


		public static function search($parameters){ }


		public static function tel($parameters){ }
