...
static const zend_function_entry phalcon_annotations_annotation_method_entry[] = {
	...
	PHP_ME(Phalcon_Annotations_Annotation, getName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Annotation, getExpression, arginfo_phalcon_annotations_annotation_getexpression, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Annotation, getExprArguments, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Annotation, getArguments, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Annotation, numberArguments, arginfo_empty, ZEND_ACC_PUBLIC)
