...
static const zend_function_entry phalcon_annotations_collection_method_entry[] = {
	...
	PHP_ME(Phalcon_Annotations_Collection, count, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, rewind, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, current, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, key, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, next, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, valid, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Annotations_Collection, getAnnotations, arginfo_empty, ZEND_ACC_PUBLIC)
