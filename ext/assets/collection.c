...
static const zend_function_entry phalcon_assets_collection_method_entry[] = {
	...
	PHP_ME(Phalcon_Assets_Collection, getResources, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, count, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, rewind, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, current, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, key, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, next, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, valid, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setTargetPath, arginfo_phalcon_assets_collection_settargetpath, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getTargetPath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setSourcePath, arginfo_phalcon_assets_collection_setsourcepath, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getSourcePath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setTargetUri, arginfo_phalcon_assets_collection_settargeturi, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getTargetUri, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setPrefix, arginfo_phalcon_assets_collection_setprefix, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getPrefix, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setLocal, arginfo_phalcon_assets_collection_setlocal, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getLocal, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, setAttributes, arginfo_phalcon_assets_collection_setattributes, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Assets_Collection, getFilters, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, join, arginfo_phalcon_assets_collection_join, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Collection, getJoin, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Assets_Collection, getTargetLocal, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
