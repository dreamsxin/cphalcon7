...
static const zend_function_entry phalcon_assets_manager_method_entry[] = {
	...
	PHP_ME(Phalcon_Assets_Manager, getSourceBasePath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Manager, setTargetBasePath, arginfo_phalcon_assets_manager_settargetbasepath, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Manager, getTargetBasePath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Manager, setTargetBaseUri, arginfo_phalcon_assets_manager_settargetbaseuri, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Manager, getTargetBaseUri, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Assets_Manager, getCss, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Assets_Manager, getJs, arginfo_empty, ZEND_ACC_PUBLIC)
