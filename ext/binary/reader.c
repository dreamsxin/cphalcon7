...
PHP_METHOD(Phalcon_Binary_Reader, append);

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_binary_reader___construct, 0, 0, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_binary_reader_append, 0, 0, 1)
...
static const zend_function_entry phalcon_binary_reader_method_entry[] = {
	...
	PHP_ME(Phalcon_Binary_Reader, getEndian, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, getInput, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, getContent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, setPosition, arginfo_phalcon_binary_reader_setposition, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, getPosition, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, getEofPosition, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, isEof, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, read, arginfo_phalcon_binary_reader_read, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readChar, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readUnsignedChar, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readInt16, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readUnsignedInt16, arginfo_phalcon_binary_reader_readunsignedint16, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readInt, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readUnsignedInt, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readInt32, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readUnsignedInt32, arginfo_phalcon_binary_reader_readunsignedint32, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readFloat, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Reader, readDouble, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Binary_Reader, append, arginfo_phalcon_binary_reader_append, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHP_METHOD(Phalcon_Binary_Reader, __construct){
	...
	if (Z_TYPE_P(data) == IS_STRING || Z_TYPE_P(data) == IS_NULL) {
		...
		if (Z_TYPE_P(data) == IS_STRING) {
			...
			if (size > 0) {
				phalcon_update_property_long(getThis(), SL("_eofPosition"), size);
...
PHP_METHOD(Phalcon_Binary_Reader, getContent){
	...
	Z_STRVAL_P(return_value)[Z_LVAL(eof_position)] = 0;
...
PHP_METHOD(Phalcon_Binary_Reader, readString){
	...
	Z_STRVAL(data)[Z_LVAL(eof_position)] = 0;
	...
	if (!phalcon_array_isset_fetch_long(return_value, &result, 1, PH_COPY)) {
		...
		PHALCON_MM_CALL_METHOD(NULL, getThis(), "setposition", &new_position);
	}
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Binary_Reader, append){
	...
	phalcon_update_property_long(getThis(), SL("_eofPosition"), Z_LVAL(eof_position) + size);
