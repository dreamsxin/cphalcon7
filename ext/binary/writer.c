...
static const zend_function_entry phalcon_binary_writer_method_entry[] = {
	...
	PHP_ME(Phalcon_Binary_Writer, getEndian, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Writer, getOutput, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Writer, getContent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Binary_Writer, getPosition, arginfo_empty, ZEND_ACC_PUBLIC)
