...
static const zend_function_entry phalcon_cache_backendinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Cache_BackendInterface, getFrontend, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Cache_BackendInterface, getOptions, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Cache_BackendInterface, isFresh, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Cache_BackendInterface, isStarted, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Cache_BackendInterface, flush, arginfo_empty)
	PHP_FE_END
};
