...
static const zend_function_entry phalcon_db_adapterinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getDescriptor, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getConnectionId, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getSQLStatement, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getExpectSQLStatement, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getSQLVariables, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getSQLBindTypes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getType, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getDialectType, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getDialect, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, affectedRows, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, close, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, begin, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, rollback, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, commit, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, isUnderTransaction, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getInternalHandler, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, useExplicitIdValue, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getDefaultIdValue, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, supportSequences, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, isNestedTransactionsWithSavepoints, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_AdapterInterface, getNestedTransactionSavepointName, arginfo_empty)
