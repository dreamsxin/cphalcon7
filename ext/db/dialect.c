...
static const zend_function_entry phalcon_db_dialect_method_entry[] = {
	...
	PHP_ME(Phalcon_Db_Dialect, supportsSavepoints, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Db_Dialect, supportsReleaseSavepoints, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Db_Dialect, getEscapeChar, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Db_Dialect, registerCustomFunction, arginfo_phalcon_db_dialect_registercustomfunction, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Db_Dialect, getCustomFunctions, arginfo_empty, ZEND_ACC_PUBLIC)
