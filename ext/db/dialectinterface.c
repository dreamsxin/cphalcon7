...
static const zend_function_entry phalcon_db_dialectinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Db_DialectInterface, supportsSavepoints, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Db_DialectInterface, supportsReleaseSavepoints, arginfo_empty)
