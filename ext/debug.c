...
static const zend_function_entry phalcon_debug_method_entry[] = {
	...
	PHP_ME(Phalcon_Debug, listenExceptions, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, listenLowSeverity, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, halt, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, debugVar, arginfo_phalcon_debug_debugvar, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, clearVars, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, _escapeString, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Debug, _getArrayDump, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Debug, _getVarDump, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Debug, getMajorVersion, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, getVersion, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, getCssSources, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, getJsSources, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, showTraceItem, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Debug, onShutdown, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, getLinesBeforeContext, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, setLinesBeforeContext, arginfo_phalcon_debug_setlines, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Debug, getLinesAfterContext, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Debug, disable, arginfo_empty, ZEND_ACC_PUBLIC | ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Debug, isEnable, arginfo_empty, ZEND_ACC_PUBLIC | ZEND_ACC_STATIC)
