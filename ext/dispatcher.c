...
static const zend_function_entry phalcon_dispatcher_method_entry[] = {
	...
	PHP_ME(Phalcon_Dispatcher, getActiveHandler, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getActiveMethod, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, isFinished, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Dispatcher, getReturnedValue, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, dispatch, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, forward, arginfo_phalcon_dispatcherinterface_forward, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, wasForwarded, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getHandlerClass, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Dispatcher, getLastException, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getLastHandler, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getPreviousNamespaceName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getPreviousActionName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Dispatcher, getPreviousParams, arginfo_empty, ZEND_ACC_PUBLIC)
