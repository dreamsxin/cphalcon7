...
static const zend_function_entry phalcon_dispatcherinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_DispatcherInterface, isFinished, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_DispatcherInterface, getReturnedValue, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_DispatcherInterface, dispatch, arginfo_empty)
