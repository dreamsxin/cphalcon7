...
static const zend_function_entry phalcon_events_event_method_entry[] = {
	...
	PHP_ME(Phalcon_Events_Event, getName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, setType, arginfo_phalcon_events_eventinterface_settype, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, getType, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, setSource, arginfo_phalcon_events_eventinterface_setsource, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, getSource, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, setData, arginfo_phalcon_events_eventinterface_setdata, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, getData, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, setCancelable, arginfo_phalcon_events_eventinterface_setcancelable, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, isCancelable, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, getFlag, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, stop, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Event, isStopped, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_MALIAS(Phalcon_Events_Event, getCancelable, isCancelable, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
