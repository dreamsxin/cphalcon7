...
static const zend_function_entry phalcon_events_manager_method_entry[] = {
	...
	PHP_ME(Phalcon_Events_Manager, arePrioritiesEnabled, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Manager, collectResponses, arginfo_phalcon_events_manager_collectresponses, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Manager, isCollecting, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Manager, getResponses, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Events_Manager, getEvents, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Events_Manager, getCurrentEvent, arginfo_empty, ZEND_ACC_PUBLIC)
