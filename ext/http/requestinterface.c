...
static const zend_function_entry phalcon_http_requestinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getScheme, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isAjax, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isSoapRequested, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isSecureRequest, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getRawBody, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getServerAddress, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getServerName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getHttpHost, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getClientAddress, arginfo_phalcon_http_requestinterface_getclientaddress)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getMethod, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getUserAgent, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isMethod, arginfo_phalcon_http_requestinterface_ismethod)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isPost, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isGet, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isPut, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isHead, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isDelete, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, isOptions, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getHTTPReferer, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getAcceptableContent, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getBestAccept, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getClientCharsets, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getBestCharset, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getLanguages, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Http_RequestInterface, getBestLanguage, arginfo_empty)
	PHP_FE_END
};
