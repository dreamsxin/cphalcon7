...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct){
	...
	checked = phalcon_fetch_static_property_ce(phalcon_image_adapter_imagick_ce, SL("_checked"));

	if (!zend_is_true(checked)) {
		PHALCON_CALL_CE_STATIC(NULL, phalcon_image_adapter_imagick_ce, "check");
	}

	phalcon_update_property_this(this_ptr, SL("_file"), *file);
	...
	if (phalcon_file_exists(*file) != FAILURE) {
		...
		phalcon_update_property_this(this_ptr, SL("_realpath"), realpath);
		...
		if (phalcon_get_intval(type) == 1) {
			...
			phalcon_update_property_this(this_ptr, SL("_image"), ret);
		} else {
			phalcon_update_property_this(this_ptr, SL("_image"), im);
		}
	} else if (w && h) {
		...
		phalcon_update_property_this(this_ptr, SL("_realpath"), *file);
		phalcon_update_property_this(this_ptr, SL("_width"), *w);
		phalcon_update_property_this(this_ptr, SL("_height"), *h);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _resize) {
	...
	phalcon_fetch_params(0, 1, 2, 0, &width, &height);

	im = phalcon_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _liquidRescale){
	...
	phalcon_fetch_params(0, 1, 4, 0, &width, &height, &delta_x, &rigidity);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _crop) {
	...
	phalcon_fetch_params(0, 1, 4, 0, &width, &height, &offset_x, &offset_y);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _rotate) {
	...
	phalcon_fetch_params(0, 1, 1, 0, &degrees);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _sharpen) {
	...
	phalcon_fetch_params(0, 1, 1, 0, &amount);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	phalcon_fetch_params(0, 1, 3, 0, &height, &opacity, &fade_in);
	...
	version      = phalcon_fetch_static_property_ce(phalcon_image_adapter_imagick_ce, SL("_version"));
	...
	phalcon_update_property_this(this_ptr, SL("_width"), w);
	phalcon_update_property_this(this_ptr, SL("_height"), h);
	phalcon_update_property_this(this_ptr, SL("_image"), image);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	phalcon_fetch_params(0, 1, 4, 0, &watermark_image, &offset_x, &offset_y, &opacity);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask){
	...
	phalcon_fetch_params(0, 1, 1, 0, &mask);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	phalcon_fetch_params(0, 1, 4, 0, &r, &g, &b, &opacity);
	...
	phalcon_update_property_this(this_ptr, SL("_image"), background);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _blur){
	...
	phalcon_fetch_params(0, 1, 1, 0, &radius);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	phalcon_fetch_params(0, 1, 2, 0, &file, &quality);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	phalcon_fetch_params(0, 1, 2, 0, &extension, &quality);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, shadow)
{
	...
	phalcon_fetch_params(0, 1, 0, 5, &color, &opacity, &sigma, &x, &y);
	...
	phalcon_update_property_this(this_ptr, SL("_image"), shadow);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, colorize)
{
	...
	phalcon_fetch_params(0, 1, 1, 1, &color, &composition);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, gamma)
{
	...
	phalcon_fetch_params(0, 1, 1, 1, &gamma, &channel);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, levels)
{
	...
	phalcon_fetch_params(0, 1, 0, 6, &gamma, &input_min, &input_max, &output_min, &output_max, &channel);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, brightness_contrast)
{
	...
	phalcon_fetch_params(0, 1, 2, 0, &brightness, &contrast);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, hsl)
{
	...
	phalcon_fetch_params(0, 1, 0, 3, &hue, &saturation, &lightness);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, curves_graph)
{
	...
	phalcon_fetch_params(0, 1, 1, 0, &fx);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, vignette)
{
	...
	phalcon_fetch_params(0, 1, 1, 2, &color, &composition, &crop_factor);
...
#ifdef PHALCON_USE_MAGICKWAND
	phalcon_fetch_params(0, 1, 1, 0, &command);
