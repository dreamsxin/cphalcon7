...
extern const char *phalcon_interned_modelsCriteria;
extern const char *phalcon_interned_modelsResultsetSimple;
extern const char *phalcon_interned_modelsResultsetComplex;
