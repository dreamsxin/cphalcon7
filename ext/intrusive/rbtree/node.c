...
static const zend_function_entry phalcon_intrusive_rbtree_node_method_entry[] = {
	...
	PHP_ME(Phalcon_Intrusive_Rbtree_Node, getValue, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Intrusive_Rbtree_Node, prev, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Intrusive_Rbtree_Node, next, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
