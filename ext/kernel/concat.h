...
#define PHALCON_CONCAT_SS(result, op1, op2) \
	 phalcon_concat_ss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, 0);
#define PHALCON_SCONCAT_SS(result, op1, op2) \
	 phalcon_concat_ss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, 1);

#define PHALCON_CONCAT_SSS(result, op1, op2, op3) \
	 phalcon_concat_sss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, 0);
#define PHALCON_SCONCAT_SSS(result, op1, op2, op3) \
	 phalcon_concat_sss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, 1);
...
#define PHALCON_MM_SCONCAT_VS(result, op1, op2) \
	 phalcon_mm_sconcat_vs(result, op1, op2, sizeof(op2)-1);
