...
#define PHALCON_CALL_SELF(retval, method, ...) PHALCON_CALL_METHOD_WITH_PARAMS(retval, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
#define PHALCON_MM_CALL_SELF(retval, method, ...) PHALCON_MM_CALL_METHOD_WITH_PARAMS(retval, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
...
#define PHALCON_RETURN_CALL_SELF(method, ...) PHALCON_CALL_METHOD_WITH_PARAMS(return_value, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
#define PHALCON_MM_RETURN_CALL_SELF(method, ...) PHALCON_MM_CALL_METHOD_WITH_PARAMS(return_value, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
...
#define PHALCON_CALL_SELF_FLAG(flag, retval, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, retval, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
...
#define PHALCON_RETURN_CALL_SELF_FLAG(flag, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, return_value, getThis(), Z_OBJCE_P(getThis()), phalcon_fcall_method, method, __VA_ARGS__)
