...
#define PHALCON_RETURN_CALL_CE_STATICW(obj_ce, method, ...) PHALCON_CALL_METHOD_WITH_PARAMSW(return_value, NULL, obj_ce, phalcon_fcall_static, method, __VA_ARGS__)
...
#define PHALCON_CALL_CE_STATIC_FLAG(flag, retval, obj_ce, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, retval, NULL, obj_ce, phalcon_fcall_static, method, __VA_ARGS__)
...
#define PHALCON_RETURN_CALL_CE_STATIC_FLAG(flag, obj_ce, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, return_value, NULL, obj_ce, phalcon_fcall_static, method, __VA_ARGS__)
