...
#define PHALCON_RETURN_CALL_CE_STATICW(class_entry, method, ...) PHALCON_CALL_METHOD_WITH_PARAMSW(return_value, NULL, class_entry, phalcon_fcall_static, method, __VA_ARGS__)
...
#define PHALCON_RETURN_CALL_CE_STATIC(class_entry, method, ...) PHALCON_CALL_METHOD_WITH_PARAMS(return_value, NULL, class_entry, phalcon_fcall_static, method, __VA_ARGS__)
...
#define PHALCON_CALL_CE_STATIC_FLAG(flag, retval, class_entry, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, retval, NULL, class_entry, phalcon_fcall_static, method, __VA_ARGS__)
...
#define PHALCON_RETURN_CALL_CE_STATIC_FLAG(flag, class_entry, method, ...) PHALCON_CALL_METHOD_WITH_FLAG(flag, return_value, NULL, class_entry, phalcon_fcall_static, method, __VA_ARGS__)
