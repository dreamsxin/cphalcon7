...
#define R3_METHOD_GET 2
#define R3_METHOD_POST 2<<1
#define R3_METHOD_PUT 2<<2
#define R3_METHOD_DELETE 2<<3
#define R3_METHOD_PATCH 2<<4
#define R3_METHOD_HEAD 2<<5
#define R3_METHOD_OPTIONS 2<<6
#define R3_METHOD_ANY 0xff

#define R3_SCHEME_HTTP     2
#define R3_SCHEME_HTTPS    2<<1
