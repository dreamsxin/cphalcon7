...
static const zend_function_entry phalcon_loader_method_entry[] = {
	PHP_ME(Phalcon_Loader, __construct, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(Phalcon_Loader, setExtensions, arginfo_phalcon_loader_setextensions, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getExtensions, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, registerNamespaces, arginfo_phalcon_loader_registernamespaces, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getNamespaces, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, registerPrefixes, arginfo_phalcon_loader_registerprefixes, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getPrefixes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, registerSufixes, arginfo_phalcon_loader_registersufixes, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getSufixes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, registerDirs, arginfo_phalcon_loader_registerdirs, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getDirs, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, registerClasses, arginfo_phalcon_loader_registerclasses, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getClasses, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, register, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, unregister, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Loader, getFoundPath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getCheckedPath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Loader, getDefault, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
