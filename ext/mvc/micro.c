...
static const zend_function_entry phalcon_mvc_micro_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Micro, getRouter, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Micro, stop, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Micro, setActiveHandler, arginfo_phalcon_mvc_micro_setactivehandler, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Micro, getActiveHandler, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Micro, getReturnedValue, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Micro, getHandlers, arginfo_empty, ZEND_ACC_PUBLIC)
