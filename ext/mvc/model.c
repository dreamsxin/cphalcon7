...
static const zend_function_entry phalcon_mvc_model_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model, getModelsMetaData, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getModelsManager, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, setTransaction, arginfo_phalcon_mvc_modelinterface_settransaction, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getTransaction, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, setSource, arginfo_phalcon_mvc_model_setsource, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getSource, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, setSchema, arginfo_phalcon_mvc_model_setschema, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getSchema, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getIdentityField, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getColumnMap, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getReverseColumnMap, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getPrimaryKeyAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getNonPrimaryKeyAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getNotNullAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getDataTypesNumeric, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, isNotNull, arginfo_phalcon_mvc_modelinterface_isnotnull, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getDataTypes, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, getBindTypes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getDefaultValues, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getAutomaticCreateAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getAutomaticUpdateAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, getReadConnectionService, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getWriteConnectionService, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, setDirtyState, arginfo_phalcon_mvc_model_setdirtystate, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getDirtyState, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getReadConnection, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getWriteConnection, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, build, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getUniqueKey, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getUniqueParams, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, _cancelOperation, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Mvc_Model, validationHasFailed, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getMessages, arginfo_phalcon_mvc_modelinterface_getmessages, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, _checkForeignKeysRestrict, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _checkForeignKeysReverseRestrict, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _checkForeignKeysReverseCascade, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _preSave, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _postSave, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _doLowInsert, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _doLowUpdate, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _preSaveRelatedRecords, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, _postSaveRelatedRecords, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Mvc_Model, delete, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getOperationMade, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, refresh, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, getSkipAttributesOnCreate, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, skipAttributesOnUpdate, arginfo_phalcon_mvc_model_skipattributesonupdate, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, getSkipAttributesOnUpdate, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, hasSnapshotData, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getSnapshotData, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, hasChanged, arginfo_phalcon_mvc_model_haschanged, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getChangedFields, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, _getRelatedRecords, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Mvc_Model, serialize, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, unserialize, arginfo_phalcon_mvc_model_unserialize, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, dump, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, getFieldValues, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model, reset, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, filter, arginfo_phalcon_mvc_model_filter, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model, isRecord, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, isNewRecord, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, isDeletedRecord, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, __debugInfo, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_MALIAS(Phalcon_Mvc_Model, getRealAttributes, getAttributes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model, jsonSerialize, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_CLASS(Phalcon_Mvc_Model){
	...
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_reverseColumnMap"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_attributes"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_primarykeyAttributes"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_nonPrimarykeyAttributes"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_notnullAttributes"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_datatypesNumeric"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_model_ce, SL("_datatypes"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_Model, getReverseColumnMap){
	...
	phalcon_read_property(return_value, getThis(), SL("_reverseColumnMap"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_reverseColumnMap"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getAttributes){
	...
	phalcon_read_property(return_value, getThis(), SL("_attributes"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_attributes"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getPrimaryKeyAttributes){
	...
	phalcon_read_property(return_value, getThis(), SL("_primarykeyAttributes"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_primarykeyAttributes"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getNonPrimaryKeyAttributes){
	...
	phalcon_read_property(return_value, getThis(), SL("_nonPrimarykeyAttributes"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_nonPrimarykeyAttributes"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getNotNullAttributes){
	...
	phalcon_read_property(return_value, getThis(), SL("_notnullAttributes"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_notnullAttributes"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getDataTypesNumeric){
	...
	phalcon_read_property(return_value, getThis(), SL("_datatypesNumeric"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_datatypesNumeric"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getDataTypes){
	...
	phalcon_read_property(return_value, getThis(), SL("_datatypes"), PH_COPY);
	if (!zend_is_true(return_value)) {
		PHALCON_MM_INIT();
		PHALCON_MM_CALL_METHOD(&meta_data, getThis(), "getmodelsmetadata");
		PHALCON_MM_ADD_ENTRY(&meta_data);
		...
		phalcon_update_property(getThis(), SL("_datatypes"), return_value);
		RETURN_MM();
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model, getReadConnection){
	...
	if (Z_TYPE(transaction) == IS_OBJECT) {
		...
		if (zend_class_implements_interface(Z_OBJCE(transaction), phalcon_db_adapterinterface_ce)) {
#else
...
PHP_METHOD(Phalcon_Mvc_Model, __set){
	...
	PHALCON_MM_ADD_ENTRY(&lower_property);

	phalcon_get_class(&model_name, getThis(), 0);
	PHALCON_MM_ADD_ENTRY(&model_name);

	PHALCON_MM_CALL_METHOD(&has, getThis(), "hasattribute", property);
	if (zend_is_true(&has)) {
		if (PHALCON_GLOBAL(orm).enable_property_method) {
			...
			if (phalcon_method_exists_ce(phalcon_mvc_model_ce, &possible_setter) != SUCCESS) {
				if (phalcon_method_exists(getThis(), &possible_setter) == SUCCESS) {
					PHALCON_MM_CALL_METHOD(NULL, getThis(), Z_STRVAL(possible_setter), value);
	...
	PHALCON_MM_CALL_METHOD(&manager, getThis(), "getmodelsmanager");
	PHALCON_MM_ADD_ENTRY(&manager);
	PHALCON_MM_CALL_METHOD(&relation, &manager, "getrelationbyalias", &model_name, &lower_property);
	 ...
	 */
	if (Z_TYPE(relation) == IS_OBJECT) {
		PHALCON_MM_CALL_METHOD(&referenced_model_name, &relation, "getreferencedmodel");
		PHALCON_MM_ADD_ENTRY(&referenced_model_name);
		...
		if (Z_TYPE_P(value) == IS_NULL) {
			...
			if (PHALCON_IS_LONG(&type, 0)) {
				if (Z_TYPE_P(value) == IS_OBJECT) {
					...
					PHALCON_MM_CALL_METHOD(&referenced_model, &manager, "load", &referenced_model_name, &PHALCON_GLOBAL(z_false));
					PHALCON_MM_ADD_ENTRY(&referenced_model);
					if (Z_TYPE(referenced_model) == IS_OBJECT) {
						PHALCON_MM_CALL_METHOD(NULL, &referenced_model, "assign", value);
					}
				} else {
					PHALCON_CONCAT_SVSVS(&exception_message, "Property \"", property, "\" must be an model `", &referenced_model_name, "`");
					PHALCON_MM_ADD_ENTRY(&exception_message);
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL(values), idx, str_key, item) {
					...
					if (Z_TYPE_P(item) == IS_OBJECT) {
						...
						PHALCON_MM_CALL_METHOD(&tmp_referenced_model_name, &relation, "getreferencedmodel");
						PHALCON_MM_ADD_ENTRY(&tmp_referenced_model_name);
						PHALCON_MM_CALL_METHOD(&referenced_model, &manager, "load", &tmp_referenced_model_name, &PHALCON_GLOBAL(z_false));
						PHALCON_MM_ADD_ENTRY(&referenced_model);
						if (Z_TYPE(referenced_model) == IS_OBJECT) {
							PHALCON_MM_CALL_METHOD(NULL, &referenced_model, "assign", item);
						}
					} else {
						PHALCON_CONCAT_SVSVS(&exception_message, "Property \"", property, "\" must be an model `", &referenced_model_name, "`");
						PHALCON_MM_ADD_ENTRY(&exception_message);
