...
static const zend_function_entry phalcon_mvc_model_criteria_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, getModelName, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, getColumns, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, getWhere, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, conditions, arginfo_phalcon_mvc_model_criteriainterface_conditions, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, getConditions, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, getIndex, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, sharedLock, arginfo_phalcon_mvc_model_criteriainterface_sharedlock, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, getParams, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, execute, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Criteria, insert, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, update, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, delete, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, getPhql, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, _generateSelect, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, _generateInsert, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, _generateUpdate, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Criteria, _generateDelete, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, insert) {
	...
	phalcon_fetch_params(0, 1, 1, &columns, &values);
	...
	if (!values || Z_TYPE_P(values) != IS_ARRAY) {
		...
		phalcon_update_property(getThis(), SL("_values"), columns);
		...
		ZEND_HASH_FOREACH_KEY(Z_ARRVAL(one), idx, str_key) {
			...
			phalcon_array_append(&keys, &name, PH_COPY);

		} ZEND_HASH_FOREACH_END();
		phalcon_update_property(getThis(), SL("_columns"), &keys);
		zval_ptr_dtor(&keys);
	} else {
