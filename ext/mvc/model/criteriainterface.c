...
static const zend_function_entry phalcon_mvc_model_criteriainterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getModelName, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getWhere, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, conditions, arginfo_phalcon_mvc_model_criteriainterface_conditions)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getColumns, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getConditions, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, orderBy, arginfo_phalcon_mvc_model_criteriainterface_orderby)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getOrder, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, limit, arginfo_phalcon_mvc_model_criteriainterface_limit)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getLimit, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getUniqueRow, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getParams, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, execute, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, insert, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, update, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, delete, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_CriteriaInterface, getPhql, arginfo_empty)
	PHP_FE_END
};
