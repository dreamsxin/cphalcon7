...
static const zend_function_entry phalcon_mvc_model_manager_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getLastInitialized, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getDefaultConnectionService, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getDefaultWriteConnectionService, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getDefaultReadConnectionService, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, clearReusableObjects, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getLastQuery, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, getNamespaceAliases, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Manager, __destruct, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_DTOR)
	PHP_FE_END
};
