...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setCustomEventsManager){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &events_manager);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getCustomEventsManager){
	...
	phalcon_fetch_params(0, 1, 1, 0, &model);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setModelSource){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &source);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setModelSchema){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &schema);
	...
	PHALCON_INIT_VAR(entity_name);
	phalcon_get_class(entity_name, model, 1);
	phalcon_update_property_array(this_ptr, SL("_schemas"), entity_name, schema);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getModelSchema){
	...
	phalcon_read_property_this(&schemas, this_ptr, SL("_schemas"), PH_NOISY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setConnectionService){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &connection_service);
	...
	PHALCON_INIT_VAR(entity_name);
	phalcon_get_class(entity_name, model, 1);
	phalcon_update_property_array(this_ptr, SL("_readConnectionServices"), entity_name, connection_service);
	phalcon_update_property_array(this_ptr, SL("_writeConnectionServices"), entity_name, connection_service);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getReadConnectionService){
	...
	phalcon_read_property_this(&connection_services, this_ptr, SL("_readConnectionServices"), PH_NOISY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getWriteConnectionService){
	...
	PHALCON_OBS_VAR(connection_services);
	phalcon_read_property_this(&connection_services, this_ptr, SL("_writeConnectionServices"), PH_NOISY);
	if (Z_TYPE_P(connection_services) == IS_ARRAY) { 
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, notifyEvent){
	...
	phalcon_fetch_params(0, 1, 2, 0, &event_name, &model);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, missingMethod){
	...
	phalcon_fetch_params(0, 1, 3, 0, &model, &event_name, &data);

	/** 
	 * Dispatch events to the global events manager
	 */
	PHALCON_OBS_VAR(behaviors);
	phalcon_read_property_this(&behaviors, this_ptr, SL("_behaviors"), PH_NOISY);
	if (Z_TYPE_P(behaviors) == IS_ARRAY) { 
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addBehavior){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &behavior);
	 ...
	 */
	phalcon_update_property_array(this_ptr, SL("_behaviors"), entity_name, models_behaviors);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, keepSnapshots){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &keep_snapshots);

	PHALCON_INIT_VAR(entity_name);
	phalcon_get_class(entity_name, model, 1);
	phalcon_update_property_array(this_ptr, SL("_keepSnapshots"), entity_name, keep_snapshots);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, useDynamicUpdate){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model, &dynamic_update);

	PHALCON_INIT_VAR(entity_name);
	phalcon_get_class(entity_name, model, 1);
	phalcon_update_property_array(this_ptr, SL("_dynamicUpdate"), entity_name, dynamic_update);
	phalcon_update_property_array(this_ptr, SL("_keepSnapshots"), entity_name, dynamic_update);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isUsingDynamicUpdate){
	...
	phalcon_read_property_this(&dynamic_update, this_ptr, SL("_dynamicUpdate"), PH_NOISY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasOne){
	...
	phalcon_fetch_params(0, 1, 4, 1, &model, &fields, &referenced_model, &referenced_fields, &options);
	...
	phalcon_read_property_this(&has_one, this_ptr, SL("_hasOne"), PH_NOISY);
	...
	phalcon_update_property_array(this_ptr, SL("_aliases"), key_alias, relation);

	/** 
	 * Update the relations
	 */
	phalcon_update_property_array(this_ptr, SL("_hasOne"), key_relation, relations);

	/** 
	 * Get existing relations by model
	 */
	PHALCON_OBS_VAR(has_one_single);
	phalcon_read_property_this(&has_one_single, this_ptr, SL("_hasOneSingle"), PH_NOISY);
	 ...
	 */
	phalcon_update_property_array(this_ptr, SL("_hasOneSingle"), entity_name, single_relations);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addBelongsTo){
	...
	phalcon_read_property_this(&belongs_to, this_ptr, SL("_belongsTo"), PH_NOISY);
	 ...
	 * Update the relations
	 */
	phalcon_update_property_array(this_ptr, SL("_belongsTo"), key_relation, relations);

	/** 
	 * Get existing relations by model
	 */
	PHALCON_OBS_VAR(belongs_to_single);
	phalcon_read_property_this(&belongs_to_single, this_ptr, SL("_belongsToSingle"), PH_NOISY);
	 ...
	 * Update relations by model
	 */
	phalcon_update_property_array(this_ptr, SL("_belongsToSingle"), entity_name, single_relations);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasMany){
	...
	phalcon_read_property_this(&has_many, this_ptr, SL("_hasMany"), PH_NOISY);
	 ...
	 * Update the relations
	 */
	phalcon_update_property_array(this_ptr, SL("_hasMany"), key_relation, relations);

	/** 
	 * Get existing relations by model
	 */
	PHALCON_OBS_VAR(has_many_single);
	phalcon_read_property_this(&has_many_single, this_ptr, SL("_hasManySingle"), PH_NOISY);
	 ...
	 * Update relations by model
	 */
	phalcon_update_property_array(this_ptr, SL("_hasManySingle"), entity_name, single_relations);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasManyToMany){
	...
	phalcon_fetch_params(0, 1, 7, 1, &model, &fields, &intermediate_model, &intermediate_fields, &intermediate_referenced_fields, &referenced_model, &referenced_fields, &options);
	...
	phalcon_read_property_this(&has_many_to_many, this_ptr, SL("_hasManyToMany"), PH_NOISY);
	 ...
	 * Update the relations
	 */
	phalcon_update_property_array(this_ptr, SL("_hasManyToMany"), key_relation, relations);

	/** 
	 * Get existing relations by model
	 */
	PHALCON_OBS_VAR(has_many_to_many_single);
	phalcon_read_property_this(&has_many_to_many_single, this_ptr, SL("_hasManyToManySingle"), PH_NOISY);
	 ...
	 * Update relations by model
	 */
	phalcon_update_property_array(this_ptr, SL("_hasManyToManySingle"), entity_name, single_relations);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, existsBelongsTo){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model_name, &model_relation);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationByAlias){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model_name, &alias);

	PHALCON_OBS_VAR(aliases);
	phalcon_read_property_this(&aliases, this_ptr, SL("_aliases"), PH_NOISY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationRecords){
	...
	phalcon_fetch_params(0, 1, 3, 1, &relation, &method, &record, &parameters);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getReusableRecords){
	...
	phalcon_fetch_params(0, 1, 2, 0, &model_name, &key);

	PHALCON_OBS_VAR(reusable);
	phalcon_read_property_this(&reusable, this_ptr, SL("_reusable"), PH_NOISY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setReusableRecords){
	...
	phalcon_fetch_params(0, 0, 3, 0, &model_name, &key, &records);

	phalcon_update_property_array(this_ptr, SL("_reusable"), key, records);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, clearReusableObjects){
	...
	phalcon_update_property_null(this_ptr, SL("_reusable"));
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getBelongsToRecords){
	...
	phalcon_fetch_params(0, 1, 4, 1, &method, &model_name, &model_relation, &record, &parameters);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelations){
	...
	phalcon_fetch_params(0, 1, 1, 0, &model_name);
	 ...
	 */
	PHALCON_OBS_VAR(belongs_to);
	phalcon_read_property_this(&belongs_to, this_ptr, SL("_belongsToSingle"), PH_NOISY);
	if (Z_TYPE_P(belongs_to) == IS_ARRAY) { 
	 ...
	 */
	PHALCON_OBS_VAR(has_many);
	phalcon_read_property_this(&has_many, this_ptr, SL("_hasManySingle"), PH_NOISY);
	if (Z_TYPE_P(has_many) == IS_ARRAY) { 
	 ...
	 */
	PHALCON_OBS_VAR(has_one);
	phalcon_read_property_this(&has_one, this_ptr, SL("_hasOneSingle"), PH_NOISY);
	if (Z_TYPE_P(has_one) == IS_ARRAY) { 
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationsBetween){
	...
	phalcon_fetch_params(0, 1, 2, 0, &first, &second);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createQuery){
	...
	phalcon_fetch_params(0, 1, 1, 0, &phql);
	...
	phalcon_update_property_this(this_ptr, SL("_lastQuery"), query);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, executeQuery){
	...
	phalcon_fetch_params(0, 1, 1, 2, &phql, &placeholders, &types);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createBuilder){
	...
	phalcon_fetch_params(0, 1, 0, 1, &params);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, registerNamespaceAlias){
	...
	phalcon_fetch_params(0, 0, 2, 0, &alias, &namespace);
	...
	phalcon_update_property_array(this_ptr, SL("_namespaceAliases"), alias, namespace);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getNamespaceAlias){
	...
	phalcon_fetch_params(0, 1, 1, 0, &alias);

	PHALCON_OBS_VAR(namespace_aliases);
	phalcon_read_property_this(&namespace_aliases, this_ptr, SL("_namespaceAliases"), PH_NOISY);
