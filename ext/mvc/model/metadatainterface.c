...
static const zend_function_entry phalcon_mvc_model_metadatainterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_MetaDataInterface, getStrategy, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Model_MetaDataInterface, getDataByte, arginfo_phalcon_mvc_model_metadatainterface_getdatabyte)
