...
static const zend_function_entry phalcon_mvc_model_query_builder_select_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getDistinct, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getColumns, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getFrom, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getOrderBy, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getHaving, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, limit, arginfo_phalcon_mvc_model_query_builder_select_limit, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getLimit, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getOffset, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, getGroupBy, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, cache, arginfo_phalcon_mvc_model_query_builder_select_cache, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Query_Builder_Select, _compile, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
