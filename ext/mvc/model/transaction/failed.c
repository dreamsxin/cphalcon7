...
static const zend_function_entry phalcon_mvc_model_transaction_failed_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model_Transaction_Failed, getRecordMessages, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Transaction_Failed, getRecord, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
