...
static const zend_function_entry phalcon_mvc_model_transaction_manager_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, getDbService, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, getRollbackPendent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, has, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, rollbackPendent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, commit, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, _collectTransaction, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Model_Transaction_Manager, collectTransactions, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_CLASS(Phalcon_Mvc_Model_Transaction_Manager){
	...
	zend_declare_property_null(phalcon_mvc_model_transaction_manager_ce, SL("_service"), ZEND_ACC_PROTECTED);
