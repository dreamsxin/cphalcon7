...
static const zend_function_entry phalcon_mvc_modelinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getSource, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getSchema, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getIdentityField, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getColumnMap, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getReverseColumnMap, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getAttributes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getPrimaryKeyAttributes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getNonPrimaryKeyAttributes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getNotNullAttributes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getDataTypesNumeric, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, isNotNull, arginfo_phalcon_mvc_modelinterface_isnotnull)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getDataTypes, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getBindTypes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getDefaultValues, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getAutomaticCreateAttributes, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getAutomaticUpdateAttributes, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getReadConnectionService, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getWriteConnectionService, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getReadConnection, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getWriteConnection, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, validationHasFailed, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, delete, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, getOperationMade, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, refresh, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ModelInterface, reset, arginfo_empty)
	PHP_FE_END
};
