...
static const zend_function_entry phalcon_mvc_router_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Router, getRewriteUri, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Router, getDefaults, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Router, clear, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router, getMatchedRoute, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Router, getControllerName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
