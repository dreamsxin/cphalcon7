...
static const zend_function_entry phalcon_mvc_router_group_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Router_Group, getHostname, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, setPrefix, arginfo_phalcon_mvc_router_group_setprefix, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getPrefix, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, beforeMatch, arginfo_phalcon_mvc_router_group_beforematch, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getBeforeMatch, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, setPaths, arginfo_phalcon_mvc_router_group_setpaths, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getPaths, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getRoutes, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, _addRoute, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Mvc_Router_Group, clear, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, convert, arginfo_phalcon_mvc_router_group_convert, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getConverters, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, setName, arginfo_phalcon_mvc_router_group_setname, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Router_Group, getName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_CLASS(Phalcon_Mvc_Router_Group){
	...
	zend_declare_property_null(phalcon_mvc_router_group_ce, SL("_converters"), ZEND_ACC_PROTECTED);
	zend_declare_property_null(phalcon_mvc_router_group_ce, SL("_name"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_Router_Group, __construct){
	...
	if (Z_TYPE_P(paths) == IS_ARRAY || Z_TYPE_P(paths) == IS_STRING) {
		phalcon_update_property(getThis(), SL("_paths"), paths);
	}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, beforeMatch){
	...
	phalcon_update_property(getThis(), SL("_beforeMatch"), before_match);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, clear){
	...
	phalcon_update_property(getThis(), SL("_routes"), &empty_routes);
}
