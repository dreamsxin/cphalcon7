...
static const zend_function_entry phalcon_mvc_routerinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, clear, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getModuleName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getControllerName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getActionName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getParams, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getMatchedRoute, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getMatches, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, wasMatched, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, getRoutes, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, isExactControllerName, arginfo_empty)
	PHP_FE_END
};
