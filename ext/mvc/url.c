...
static const zend_function_entry phalcon_mvc_url_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_Url, getBaseUri, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Url, getStaticBaseUri, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Url, setBasePath, arginfo_phalcon_mvc_urlinterface_setbasepath, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Url, getBasePath, arginfo_empty, ZEND_ACC_PUBLIC)
