...
static const zend_function_entry phalcon_mvc_view_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_View, getViewsDir, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setLayoutsDir, arginfo_phalcon_mvc_viewinterface_setlayoutsdir, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getLayoutsDir, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setPartialsDir, arginfo_phalcon_mvc_viewinterface_setpartialsdir, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getPartialsDir, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setBasePath, arginfo_phalcon_mvc_viewinterface_setbasepath, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getBasePath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getCurrentRenderLevel, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getRenderLevel, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_View, getControllerName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setActionName, arginfo_phalcon_mvc_viewinterface_setactionname, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getActionName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setParams, arginfo_phalcon_mvc_viewinterface_setparams, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getParams, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, setNamespaceName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getNamespaceName, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, start, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, _loadTemplateEngines, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_View, _engineRender, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_View, registerEngines, arginfo_phalcon_mvc_viewinterface_registerengines, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getRegisteredEngines, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getEngines, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_View, finish, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, _createCache, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_View, isCaching, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getCache, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_View, getContent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, startSection, arginfo_phalcon_mvc_viewinterface_startsection, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, stopSection, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, section, arginfo_phalcon_mvc_viewinterface_section, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, getActiveRenderPath, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, disable, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, enable, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, isDisabled, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, enableNamespaceView, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, disableNamespaceView, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, enableMultiNamespaceView, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, disableMultiNamespaceView, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, enableLowerCase, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View, disableLowerCase, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_View, reset, arginfo_empty, ZEND_ACC_PUBLIC)
...
PHP_METHOD(Phalcon_Mvc_View, render){
	...
	if (zend_is_true(&render_level)) {
		...
		if (view_model && Z_TYPE_P(view_model) == IS_OBJECT && zend_class_implements_interface(Z_OBJCE_P(view_model), phalcon_mvc_view_modelinterface_ce)) {
#else
