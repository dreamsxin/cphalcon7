...
static const zend_function_entry phalcon_mvc_view_simple_method_entry[] = {
	...
	PHP_ME(Phalcon_Mvc_View_Simple, getViewsDir, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, registerEngines, arginfo_phalcon_mvc_view_simple_registerengines, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, getRegisteredEngines, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, _loadTemplateEngines, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_View_Simple, _internalRender, arginfo_empty, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Mvc_View_Simple, getCacheOptions, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, _createCache, arginfo_empty, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_View_Simple, getCache, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_View_Simple, getParamsToView, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, setContent, arginfo_phalcon_mvc_view_simple_setcontent, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, getContent, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, startSection, arginfo_phalcon_mvc_view_simple_startsection, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, stopSection, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, section, arginfo_phalcon_mvc_view_simple_section, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_View_Simple, getActiveRenderPath, arginfo_empty, ZEND_ACC_PUBLIC)
