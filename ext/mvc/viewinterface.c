...
static const zend_function_entry phalcon_mvc_viewinterface_method_entry[] = {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getViewsDir, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, setLayoutsDir, arginfo_phalcon_mvc_viewinterface_setlayoutsdir)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getLayoutsDir, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, setPartialsDir, arginfo_phalcon_mvc_viewinterface_setpartialsdir)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getPartialsDir, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, setBasePath, arginfo_phalcon_mvc_viewinterface_setbasepath)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getBasePath, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getCurrentRenderLevel, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getRenderLevel, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getControllerName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, setActionName, arginfo_phalcon_mvc_viewinterface_setactionname)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getActionName, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, setParams, arginfo_phalcon_mvc_viewinterface_setparams)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getParams, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, start, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, registerEngines, arginfo_phalcon_mvc_viewinterface_registerengines)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getRegisteredEngines, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getEngines, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, finish, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, isCaching, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getCache, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getContent, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, startSection, arginfo_phalcon_mvc_viewinterface_startsection)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, stopSection, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, section, arginfo_phalcon_mvc_viewinterface_section)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getActiveRenderPath, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, disable, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, enable, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, isDisabled, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, enableNamespaceView, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, disableNamespaceView, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, enableLowerCase, arginfo_empty)
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, disableLowerCase, arginfo_empty)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, reset, arginfo_empty)
	PHP_FE_END
};
