...
static const zend_function_entry phalcon_process_proc_method_entry[] = {
	...
	PHP_ME(Phalcon_Process_Proc, __destruct, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, setMode, arginfo_phalcon_process_proc_setmode, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, getDescriptors, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, isPtySupported, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, start, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, stop, arginfo_phalcon_process_proc_stop, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, close, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, reStart, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, isRunning, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Process_Proc, checkTimeout, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, getPid, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Process_Proc, wait, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Process_Proc, hasSystemCallBeenInterrupted, arginfo_empty, ZEND_ACC_PROTECTED)
