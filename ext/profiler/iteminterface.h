...
#ifndef PHALCON_PROFILER_ITEMINTERFACE_H
#define PHALCON_PROFILER_ITEMINTERFACE_H

#include "php_phalcon.h"

extern zend_class_entry *phalcon_profiler_iteminterface_ce;

PHALCON_INIT_CLASS(Phalcon_Profiler_ItemInterface);

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_profiler_iteminterface_setdata, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, data, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_profiler_iteminterface_setinitialtime, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, initialTime, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_profiler_iteminterface_setfinaltime, 0, 0, 1)
