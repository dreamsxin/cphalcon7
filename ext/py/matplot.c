...
static const zend_function_entry phalcon_py_matplot_method_entry[] = {
	...
	PHP_ME(Phalcon_Py_Matplot, figure, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, legend, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, ylim, arginfo_phalcon_py_matplot_ylim, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, getYlim, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, xlim, arginfo_phalcon_py_matplot_xlim, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, getXlim, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, subplot, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Py_Matplot, show, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, close, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, draw, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, pause, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, save, arginfo_phalcon_py_matplot_save, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, clf, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Py_Matplot, tightLayout, arginfo_empty, ZEND_ACC_PUBLIC)
