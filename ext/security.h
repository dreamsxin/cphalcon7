...
#define PHALCON_SECURITY_CRYPT_BLOWFISH_A       5
#define PHALCON_SECURITY_CRYPT_BLOWFISH_X       6
#define PHALCON_SECURITY_CRYPT_BLOWFISH_Y       7
#define PHALCON_SECURITY_CRYPT_SHA256           8
#define PHALCON_SECURITY_CRYPT_SHA512           9
