...
PHALCON_INIT_CLASS(Phalcon_Session_Adapter_Libmemcached){
	...
	zend_declare_property_null(phalcon_session_adapter_libmemcached_ce, SL("_lifetime"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, read){
	...
	libmemcached = phalcon_fetch_nproperty_this(this_ptr, SL("_libmemcached"), PH_NOISY);
