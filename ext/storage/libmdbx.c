...
static const zend_function_entry phalcon_storage_libmdbx_method_entry[] = {
	...
	PHP_ME(Phalcon_Storage_Libmdbx, commit, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Storage_Libmdbx, renew, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Storage_Libmdbx, reset, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Storage_Libmdbx, cursor, arginfo_empty, ZEND_ACC_PUBLIC)
