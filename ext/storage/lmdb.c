...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_storage_lmdb_getall, 0, 0, 0)
...
static const zend_function_entry phalcon_storage_lmdb_method_entry[] = {
	...
	PHP_ME(Phalcon_Storage_Lmdb, commit, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Storage_Lmdb, renew, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Storage_Lmdb, reset, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Storage_Lmdb, getAll, arginfo_phalcon_storage_lmdb_getall, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Storage_Lmdb, cursor, arginfo_empty, ZEND_ACC_PUBLIC)
...
PHALCON_INIT_CLASS(Phalcon_Storage_Lmdb){
	...
	zend_declare_property_null(phalcon_storage_lmdb_ce, SL("_frontend"), ZEND_ACC_PROTECTED);
