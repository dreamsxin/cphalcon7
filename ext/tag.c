...
static const zend_function_entry phalcon_tag_method_entry[] = {
	...
	PHP_ME(Phalcon_Tag, getDI, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, getUrlService, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, getEscaperService, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, getAutoescape, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Phalcon_Tag, resetInput, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, linkTo, arginfo_phalcon_tag_linkto, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, _inputField, arginfo_empty, ZEND_ACC_STATIC|ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Tag, _inputFieldChecked, arginfo_empty, ZEND_ACC_STATIC|ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Tag, endForm, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Phalcon_Tag, getTitleSeparator, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Phalcon_Tag, getDocType, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Phalcon_Tag, getDefaults, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, setDefaultParams, arginfo_phalcon_tag_setdefaultparams, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, getDefaultParams, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, setDefaultFormParams, arginfo_phalcon_tag_setdefaultformparams, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Tag, getDefaultFormParams, arginfo_empty, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
...
PHP_METHOD(Phalcon_Tag, linkTo){
	...
	PHALCON_MM_CALL_CE_STATIC(&url, phalcon_tag_ce, "geturlservice");
	PHALCON_MM_ADD_ENTRY(&url);
...
PHP_METHOD(Phalcon_Tag, _inputField){
	...
	if (PHALCON_IS_FALSE(as_value)) {
		...
		if (zend_is_true(&id)) {
			...
			PHALCON_MM_CALL_CE_STATIC(&value, phalcon_tag_ce, "getvalue", &name, &params);
		}
...
static void phalcon_tag_generic_field(INTERNAL_FUNCTION_PARAMETERS, const char* type, int as_value)
{
	...
	if (as_value) {
		PHALCON_MM_CALL_CE_STATIC(return_value, phalcon_tag_ce, "_inputfield", &field_type, parameters, &PHALCON_GLOBAL(z_true));
	} else {
		PHALCON_MM_CALL_CE_STATIC(return_value, phalcon_tag_ce, "_inputfield", &field_type, parameters);
	}
	RETURN_MM();
}
...
static void phalcon_tag_generic_field_checked(INTERNAL_FUNCTION_PARAMETERS, const char* type)
{
	...
	PHALCON_MM_ZVAL_STRING(&field_type, type);
	PHALCON_MM_CALL_CE_STATIC(return_value, phalcon_tag_ce, "_inputfieldchecked", &field_type, parameters);
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Tag, textArea){
	...
	PHALCON_CALL_CE_STATIC(&content, phalcon_tag_ce, "getvalue", &id, &params);
...
PHP_METHOD(Phalcon_Tag, form){
	...
	if (Z_TYPE(params_action) != IS_NULL) {
		PHALCON_CALL_CE_STATIC(&url, phalcon_tag_ce, "geturlservice");
