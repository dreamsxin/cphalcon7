...
PHP_METHOD(Phalcon_Validation, validate){
	...
	validators = phalcon_read_property(this_ptr, SL("_validators"), PH_NOISY);
	if (Z_TYPE_P(validators) != IS_ARRAY) { 
	 ...
	 */
	messages = phalcon_read_property(this_ptr,  SL("_messages"), PH_NOISY);
...
PHP_METHOD(Phalcon_Validation, getValue){
	...
	entity = phalcon_read_property(this_ptr, SL("_entity"), PH_NOISY);
	 ...
	 */
	values = phalcon_read_property(this_ptr, SL("_values"), PH_NOISY);
