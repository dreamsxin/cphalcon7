...
PHP_METHOD(Phalcon_Validation, setDefaultMessages)
{
	...
	add_assoc_stringl_ex(default_messages, SL("Alnum"),             SL("Field :field must contain only letters and numbers"));
	add_assoc_stringl_ex(default_messages, SL("Alpha"),             SL("Field :field must contain only letters"));
	add_assoc_stringl_ex(default_messages, SL("Between"),           SL("Field :field must be within the range of :min to :max"));
	add_assoc_stringl_ex(default_messages, SL("Confirmation"),      SL("Field :field must be the same as :with"));
	add_assoc_stringl_ex(default_messages, SL("Digit"),             SL("Field :field must be numeric"));
	add_assoc_stringl_ex(default_messages, SL("Email"),             SL("Field :field must be an email address"));
	add_assoc_stringl_ex(default_messages, SL("ExclusionIn"),       SL("Field :field must not be a part of list: :domain"));
	add_assoc_stringl_ex(default_messages, SL("FileEmpty"),         SL("Field :field must not be empty"));
	add_assoc_stringl_ex(default_messages, SL("FileIniSize"),       SL("File :field exceeds the maximum file size"));
	add_assoc_stringl_ex(default_messages, SL("FileMaxResolution"), SL("File :field must not exceed :max resolution"));
	add_assoc_stringl_ex(default_messages, SL("FileMinResolution"), SL("File :field must be at least :min resolution"));
	add_assoc_stringl_ex(default_messages, SL("FileSize"),          SL("File :field exceeds the size of :max"));
	add_assoc_stringl_ex(default_messages, SL("FileMaxSize"),       SL("File :field the size must not exceed :max"));
	add_assoc_stringl_ex(default_messages, SL("FileMinSize"),       SL("File :field the size must be at least :min"));
	add_assoc_stringl_ex(default_messages, SL("FileType"),          SL("File :field must be of type: :types"));
	add_assoc_stringl_ex(default_messages, SL("FileValid"),         SL("Field :field is not valid"));
	add_assoc_stringl_ex(default_messages, SL("ImageMaxWidth"),     SL("Image :field the width must not exceed :max"));
	add_assoc_stringl_ex(default_messages, SL("ImageMinWidth"),     SL("Image :field the width must be at least :min"));
	add_assoc_stringl_ex(default_messages, SL("ImageMaxHeight"),    SL("Image :field the height must not exceed :max"));
	add_assoc_stringl_ex(default_messages, SL("ImageMinHeight"),    SL("Image :field the height must be at least :min"));
	add_assoc_stringl_ex(default_messages, SL("Identical"),         SL("Field :field does not have the expected value"));
	add_assoc_stringl_ex(default_messages, SL("InclusionIn"),       SL("Field :field must be a part of list: :domain"));
	add_assoc_stringl_ex(default_messages, SL("PresenceOf"),        SL("Field :field is required"));
	add_assoc_stringl_ex(default_messages, SL("Regex"),             SL("Field :field does not match the required format"));
	add_assoc_stringl_ex(default_messages, SL("TooLong"),           SL("Field :field must not exceed :max characters long"));
	add_assoc_stringl_ex(default_messages, SL("TooShort"),          SL("Field :field must be at least :min characters long"));
	add_assoc_stringl_ex(default_messages, SL("Uniqueness"),        SL("Field :field must be unique"));
	add_assoc_stringl_ex(default_messages, SL("Url"),               SL("Field :field must be a url"));
