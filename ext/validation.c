...
static const zend_function_entry phalcon_validation_method_entry[] = {
	...
	PHP_ME(Phalcon_Validation, getValidators, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Validation, setEntity, arginfo_phalcon_validation_setentity, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Validation, getEntity, arginfo_empty, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Validation, getMessages, arginfo_empty, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Validation, getData, arginfo_empty, ZEND_ACC_PUBLIC)
